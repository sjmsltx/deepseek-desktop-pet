# -*- coding: utf-8 -*-
"""step1: 模块地图注入 build_system_prompt + 更新 5/7 条提示词"""
import io
...
# 2. build_system_prompt 参数加 module_map 注入：在【桌宠自身能力】前插入结构说明
old2 = "        + '\\n\\n【桌宠自身能力（重要，不要改源码）】桌宠有完整的插件系统/主题系统/MCP 扩展能力：\\n'"
new2 = "        + '\\n\\n' + MODULE_MAP\n        + '\\n\\n【桌宠自身能力（重要，不要改源码）】桌宠有完整的插件系统/主题系统/MCP 扩展能力：\\n'"
assert old2 in src, '能力段未找到'
...
assert old5 in src, '第5条未找到'
src = src.replace(old5, new5, 1)

# 4. 第 7 条：引导 search_code + edit 指定 file
...
print('✅ prompt_builder 模块地图 + 提示词更新')
